...
<form id="file_attachment_file" method="post" enctype="multipart/form-data" action="javascript:void(0);" autocomplete="on">
...
<form action="process/processfileimage.php" method="post" >
    <br />
    <div id="vpb_upload_status"></div>
    <br />

    <div class="form-group">
        <label for="inputName">Име на фајлот: </label>
        <input type="text" class="form-control" id="inputName" placeholder="Внесете име.. " name="name">
    </div>
