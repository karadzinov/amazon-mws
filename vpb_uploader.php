...
if (isset($_POST) && $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $vpb_with_of_first_image_file = 250;      // You may adjust the width here as you wish
    $vpb_with_of_second_image_file = 250;     // You may adjust the height here as you wish
